...
namespace TranslatorInterface.MicrosoftTranslator {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TranslatorInterface.MicrosoftTranslator.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public TranslatorInterface.MicrosoftTranslator.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        TranslatorInterface.MicrosoftTranslator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, TranslatorInterface.MicrosoftTranslator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, TranslatorInterface.MicrosoftTranslator.Translation[] translations, string from, string to, TranslatorInterface.MicrosoftTranslator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        TranslatorInterface.MicrosoftTranslator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, TranslatorInterface.MicrosoftTranslator.TranslateOptions options);
        ...
        TranslatorInterface.MicrosoftTranslator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, TranslatorInterface.MicrosoftTranslator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : TranslatorInterface.MicrosoftTranslator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<TranslatorInterface.MicrosoftTranslator.LanguageService>, TranslatorInterface.MicrosoftTranslator.LanguageService {
        ...
        public TranslatorInterface.MicrosoftTranslator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, TranslatorInterface.MicrosoftTranslator.TranslateOptions options) {
